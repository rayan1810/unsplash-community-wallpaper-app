...
function Component(props: { navigation: { toggleDrawer: () => void; }; route: { name: boolean | React.ReactChild | React.ReactFragment | React.ReactPortal | null | undefined; }; }) {
  return (
...
function CustomDrawerContent(props:any) {
  return (
    ...
    <VStack divider={<Divider />} space={4}>
      <VStack space={3}>
        {props.state.routeNames.map((name: boolean | React.ReactChild | React.ReactFragment | React.ReactPortal | null | undefined, index: any) => (
            <Pressable
              px={5}
              py={3}
              rounded="md"
